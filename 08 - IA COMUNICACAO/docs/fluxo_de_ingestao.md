...
- texto puro
- audio
- imagem, video, documento e outras midias de WhatsApp
- metadados de origem
...
Midias sem legenda ou transcricao entram como evento operacional com texto padrao, por exemplo `[audio recebido]` ou `[imagem recebida]`, para preservar a atividade da conversa e evitar falso alerta de inatividade.
